...
function PropertyBuilder (propName) {
  ...
  Property.prototype.sparse = function (enabled, msg) {
    return this.validate(msg || propName + ' cannot have undefiend values', function (value) {
  ...
  Property.prototype.min = function (min, msg) {
    return this.validate(msg || (propName + ' must be at least ' + min), function (value) {
  ...
  Property.prototype.max = function (max, msg) {
    return this.validate(msg || (propName + ' must no more than than ' + max), function (value) {
  ...
  Property.prototype.length = function (length, msg) {
    return this.validate(msg || (propName + ' must be exactly ' + length), function (value) {
  ...
  Property.prototype.alphanum = function (msg) {
    return this.validate(msg || propName + ' should contain alpha-numeric characters only', function (value) {
  ...
  Property.prototype.regex = function (regex, msg) {
    return this.validate(msg || propName + ' is invalid', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.email = function (msg) {
    return this.validate(msg || propName + ' is not a valid email', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.guid = function (msg) {
    return this.validate(msg || propName + ' is not a valid GUID', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.hostname = function (msg) {
    return this.validate(msg || propName + ' is not a valid host name', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.uppercase = function (msg) {
    return this.validate(msg || propName + ' is not uppercase', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.lowercase = function (msg) {
    return this.validate(msg || propName + ' is not lowercase', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.greater = function (greater, msg) {
    return this.validate(msg || (propName + ' must be greater than ' + greater), function (value) {
  ...
  Property.prototype.less = function (less, msg) {
    return this.validate(msg || (propName + ' must be less than ' + less), function (value) {
      if (utils.isNumber(value)) {
        return value < less;
      }
  ...
  Property.prototype.integer = function (msg) {
    return this.validate(msg || (propName + ' must be an integer'), function (value) {
      if (utils.isNumber(value)) {
  ...
  Property.prototype.encoding = function (encoding, msg) {
    return this.validate(msg || (propName + ' must be less than ' + max), function (value) {
