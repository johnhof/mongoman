...
function PropertyBuilder (propName) {
  ...
  Property.prototype.max = function (max, msg) {
    return this.validator(msg || (propName + ' must no more than than ' + max), function (value) {
  ...
  Property.prototype.alphanum = function (msg) {
    return this.validator(msg || propName + ' should contain alpha-numeric characters only', function (value) {
  ...
  Property.prototype.regex = function (regex, msg) {
    return this.validator(msg || propName + ' is invalid', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.email = function (msg) {
    return this.validator(msg || propName + ' is not a valid email', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.guid = function (msg) {
    return this.validator(msg || propName + ' is not a valid GUID', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.hostname = function (msg) {
    return this.validator(msg || propName + ' is not a valid host name', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.uppercase = function (msg) {
    return this.validator(msg || propName + ' is not uppercase', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.lowercase = function (msg) {
    return this.validator(msg || propName + ' is not lowercase', function (value) {
      if (utils.isString(value)) {
  ...
  Property.prototype.greater = function (greater, msg) {
    return this.validator(msg || (propName + ' must be greater than ' + greater), function (value) {
  ...
  Property.prototype.less = function (less, msg) {
    return this.validator(msg || (propName + ' must be less than ' + less), function (value) {
      if (utils.isNumber(value)) {
        return value < less;
      }
  ...
  Property.prototype.integer = function (msg) {
    return this.validator(msg || (propName + ' must be an integer'), function (value) {
      if (utils.isNumber(value)) {
